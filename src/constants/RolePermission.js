export const permissionRole = {
  ...
  'Leave Management': [
    ...
    {name: 'coworkersLeaves', label: 'Co-workers Leaves', rule: []},
  ...
  Resources: [
    ...
    {name: 'editFAQ', label: 'Edit Policy', rule: []},
    {name: 'editFAQ', label: 'Edit Holiday', rule: []},
    {name: 'viewFAQ', label: 'View FAQ', rule: []},
    {name: 'viewFAQ', label: 'View Policy', rule: []},
    {name: 'viewFAQ', label: 'View Holiday', rule: []},
    {name: 'deleteFAQ', label: 'Delete FAQ', rule: []},
    {name: 'deleteFAQ', label: 'Delete Policy', rule: []},
    {name: 'deleteFAQ', label: 'Delete Holiday', rule: []},
  ],
  Settings: [
    {name: 'coWorkers', label: 'Co-Workers', rule: []},
    {name: 'projects', label: 'Projects', rule: []},
