const style = {lineHeight: 0}
export const NOTIFICATION_ICONS: any = {
  User: <i className={`icon icon-contacts gx-fs-md`} style={style} />,
  Attendance: <i className={`icon icon-select gx-fs-md`} style={style} />,
