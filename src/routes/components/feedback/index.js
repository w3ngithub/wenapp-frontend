...
const Feedback = ({match}) => (
  <Switch>
    ...
    <Route
      path={`${match.url}/alert`}
      component={asyncComponent(() => import('./Alert/'))}
    />
    <Route
      path={`${match.url}/modal`}
      component={asyncComponent(() => import('./Modal/'))}
    />
    <Route
    ...
    />
    <Route
      path={`${match.url}/popconfirm`}
      component={asyncComponent(() => import('./PopConfirm/'))}
    />
    <Route
      path={`${match.url}/spin`}
      component={asyncComponent(() => import('./Spin/'))}
    />
  </Switch>
)
